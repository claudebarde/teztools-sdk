                            ...
                            contractKeys.forEach(contractKey => {
                                ...
                                switch (contractKey) {
                                    ...
                                    case "tokenAddress":
                                        ...
                                        token.tokenAddress = (() => {
                                            if (this.is_string(tokenAddress) &&
                                    ...
                                    case "shouldPreferSymbol":
                                        token.shouldPreferSymbol = this.is_boolean(contract[contractKey])
...
exports.default = TezToolsPrices;
